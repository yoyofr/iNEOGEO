...
static char * default_p1control = "A=K49,B=K51,C=K50,D=K52,START=K53,COIN=K54,"
"UP=K117,DOWN=K100,LEFT=K108,RIGHT=K114,MENU=K56,TURBO=K55";
static char * default_p2control = "";
...
#else
	cf_create_string_item("rompath", "Tell gngeo where your roms are", "PATH", 'i', ROM_DIRECTORY);
	cf_create_string_item("biospath", "Tell gngeo where your neogeo bios is", "PATH", 'B', ROM_DIRECTORY);
