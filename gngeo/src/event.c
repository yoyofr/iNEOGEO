...
t_touch_area virtual_stick_iphone[VSTICK_NB_BUTTON]={
    {GN_A,          350,200,50,50,0},
    {GN_B,          430,200,50,50,0},
    {GN_C,          350,270,50,50,0},
    {GN_D,          430,270,50,50,0},
    
    {GN_UP,          50,170,50,50,0},
    
    {GN_UPLEFT,       0,170,50,50,0},
    {GN_LEFT,         0,220,50,50,0},
    {GN_DOWNLEFT,     0,270,50,50,0},        
    
    {GN_DOWN,        50,270,50,50,0}, 
    {GN_DOWNRIGHT,  100,270,50,50,0},
    {GN_RIGHT,      100,220,50,50,0},
    {GN_UPRIGHT,    100,170,50,50,0},
    
    {GN_START,      430,  0,50,50,0},
    {GN_SELECT_COIN,430, 70,50,50,0},
    {GN_MENU_KEY,     0,  0,50,50,0},
    {GN_TURBO,        0, 70,50,50,0}
};

t_touch_area virtual_stick_ipad_landscape[VSTICK_NB_BUTTON]={
    {GN_A,          1024-80*2-20,768-80*2-20,80,80,0},
    {GN_B,          1024-80,768-80*2-20,80,80,0},
    {GN_C,          1024-80*2-20,768-80,80,80,0},
    {GN_D,          1024-80,768-80,80,80,0},
    
    {GN_UP,          80,768-80*3,80,80,0},
    
    {GN_UPLEFT,       0,768-80*3,80,80,0},
    {GN_LEFT,         0,768-80*2,80,80,0},
    {GN_DOWNLEFT,     0,768-80,80,80,0},        
    
    {GN_DOWN,        80,768-80,80,80,0}, 
    {GN_DOWNRIGHT,  160,768-80,80,80,0},
    {GN_RIGHT,      160,768-80*2,80,80,0},
    {GN_UPRIGHT,    160,768-80*3,80,80,0},
    
    {GN_START,      1024-80,  0,80,80,0},
    {GN_SELECT_COIN,1024-80, 100,80,80,0},
    {GN_MENU_KEY,     0,  0,80,80,0},
    {GN_TURBO,        0, 100,80,80,0}
};


t_touch_area *virtual_stick=virtual_stick_iphone;
int gTurboMode;
	...
	while (SDL_PollEvent(&event)) {
    	...
    	switch (event.type) {
            ...
            case SDL_FINGERMOTION:
                ...
                rx = event.tfinger.x*device_w / state->xres;
                ry = event.tfinger.y*device_h / state->yres;
