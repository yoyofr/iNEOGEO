...
;@ For commercial use, separate licencing terms must be obtained.
      ...
      .global DrZ80Ver
	   ...
	   INTERRUPT_MODE= 		0		;@0 = Use internal int handler, 1 = Use Mames int handler
	   FAST_Z80SP=			1		;@0 = Use mem functions for stack pointer, 1 = Use direct mem pointer
	   GNGEO_OPTIM=                   1		;@0 = Use mem handler and rebase pc/sp, 1 = Use optim for gngeo
...
;@ Make sure that regs/pointers for z80pc to z80sp match up!
	...
	z80xx .req lr
	 ...
	 z80pc_pointer=           0                  ;@  0
	 z80a_pointer=            z80pc_pointer+4    ;@  4
	 z80f_pointer=            z80a_pointer+4     ;@  8
	 z80bc_pointer=           z80f_pointer+4     ;@  
	 z80de_pointer=           z80bc_pointer+4
	 z80hl_pointer=           z80de_pointer+4
	 z80sp_pointer=           z80hl_pointer+4
	 z80pc_base=              z80sp_pointer+4
	 z80sp_base=              z80pc_base+4
	 z80ix=                   z80sp_base+4
	 z80iy=                   z80ix+4
	 z80i=                    z80iy+4
	 z80a2=                   z80i+4
